...
/**
 * A sequence which manages it's elements as a singly linked list while limiting the maximum number of elements in the
 * list.
 *
 * @param <T> The type of elements stored in this sequence.
 */
public class FixedSinglyLinkedSequence<T> extends SinglyLinkedSequence<T> implements FixedSequence<T>, Deque<T> {
    ...
    public FixedSinglyLinkedSequence(int maxSize) {
